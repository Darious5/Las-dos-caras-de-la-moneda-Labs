...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        // Se aplica htmlspecialchars a la salida del nombre de usuario
        echo "Usuario <strong>" . htmlspecialchars($username) . "</strong> registrado. <a href='index_seguro.html'>Inicia sesión</a>";
    } else {
